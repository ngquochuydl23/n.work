...
namespace n.work.Migrations
{
    ...
    [Migration("20201028061820_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("n.work.Models.ActivityDetail", b =>
                {
            ...
            modelBuilder.Entity("n.work.Models.ItemActivity", b =>
                {
                    b.Property<int>("ActivityId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("n.work.Models.ActivityDetail", b =>
                {
                    b.HasOne("n.work.Entity.WorkerAccount", "Worker")
                        ...
                        .HasForeignKey("n.work.Models.ActivityDetail", "ActivityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("n.work.Models.ItemActivity", b =>
                {
                    b.HasOne("n.work.Models.ActivityDetail", "ActivityDetail")
                        .WithOne("ItemActivity")
                        .HasForeignKey("n.work.Models.ItemActivity", "ActivityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
